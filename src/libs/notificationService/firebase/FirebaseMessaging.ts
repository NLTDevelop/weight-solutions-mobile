import { deleteToken, getInitialNotification, getMessaging, getToken, hasPermission, onMessage, onNotificationOpenedApp, onTokenRefresh, setBackgroundMessageHandler } from '@react-native-firebase/messaging';
